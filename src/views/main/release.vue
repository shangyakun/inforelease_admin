...
<!-- </video> -->
        ...
        <div style="background: #fff;width:100%;" class="clear" v-loading='showLoading'>
            <el-col :span="24">
                <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
                    ...
                    <el-form-item label="文档分类" prop='category'>
                        <el-select @change="changeCategory" clearable v-model="ruleForm.category" class='' placeholder="请选择文档分类">
                            <el-option
                    ...
                    <el-form-item label="封面图片" v-if='msgType!=1' prop='cover'>
                        <el-input 
                            v-show='false'
                            class='input'
                            type="text"
    ...
    methods: {
        ...
        deleteRange(i,index){
            if(i==0){
                ...
                list = list.concat(this.userRange);
                ...
                for(let i=0;i<checkList.length;i++){
                    if(checkList[i].supdepid!='-1'){
                        this.departmentRange.push({
                            departmentname:checkList[i].departmentname,
                            id:checkList[i].id
                        })
                    }else{
                        this.userRange.push({
        ...
        releaseArticle(){
            ...
            let dateRepeat = '';
            let attachment = '';
            if(this.releaseType==3){//判断是不是定时发布
        ...
        uploadVideoSuccess(res){
            if(res.success){
                const str = '<iframe style="height:300px;" src='+res.data.url+' ></iframe>';
